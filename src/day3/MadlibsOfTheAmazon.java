...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more" + a + "during the day, so cross the river at night. Piranhas are attracted to fresh" + b + "and wil most likely bite off your" + c + "if you" + d + ". Whatever you do, if you have a open wound, try to find another way to get back to" + e);
